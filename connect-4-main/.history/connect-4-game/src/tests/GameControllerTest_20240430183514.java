...
public class GameControllerTest {
    ...
    public class StubbedGameModel extends GameModel {
        ...
        public PlayGameResponse makeMove(int gameId, int playerId, int column) {
            ...
            return new PlayGameResponse(true, "", gameId, 1, 2, 1, "Playing", "0000000000000000000000000");
        }
    }
    ...
    public void testValidMove() {
        ...
        when(gameModelMock.makeMove(anyInt(), anyInt(), anyInt()))
                .thenReturn(new PlayGameResponse(true, "", 1, 1, 2, 1, "Playing", "0000000000000000000000000"));
