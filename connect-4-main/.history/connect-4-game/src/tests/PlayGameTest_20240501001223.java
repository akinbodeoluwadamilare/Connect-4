...
public class PlayGameTest {
    ...
    public void testValidMoveResultingInWinningCombination() {
        ...
        when(gameModelMock.makeMove(anyInt(), anyInt(), anyInt())).thenReturn(new PlayGameResponse(true, "", 1, 1, 2, 1, "Completed", "0000000000000000000000000")); // Simulate successful move resulting in winning combination
