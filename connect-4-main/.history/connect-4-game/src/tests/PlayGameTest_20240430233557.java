...
public class PlayGameTest {
    ...
    public void testInvalidMove_InvalidPlayerID() {
        ...
        assertEquals(-1, response.getGameId()); // Check if the game ID is 0
        assertEquals(-1, response.getPlayer1Id()); // Check if player1 is null
        assertEquals(-1, response.getPlayer2Id()); // Check if player2 is null
        assertEquals(-1, response.getCurrentTurnPlayer()); // Check if current turn player is 0
        assertEquals(null, response.getGameStatus()); // Check if the game status is null
        assertEquals(null, response.getGameBoard()); // Check if the game board is null
    }
    ...
    public void testInvalidMove_InvalidColumn() {
        ...
        assertEquals(-1, response.getPlayer1Id()); // Check if player1 ID is 0
